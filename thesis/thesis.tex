...
\parencite{hankerson_elliptic_2011} \parencite{schneier_essays_2007}
...
as a trusted party where so called Prekey Bundles are uploaded. These Bundles contain information which is needed to create a session to a communication partner.
