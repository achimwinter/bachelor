...
Since Android 9 (API Level 28), smartphones can have a Strongbox Keymaster, which relies on separated hardware which is only used for cryptographic operations.
